# Criando um App Contador Flutuante
Aplicativo auxiliar para jogos de turnos, um contador flutuante simples para ajudar o usuário a não perder o foco em suas estratégias.
